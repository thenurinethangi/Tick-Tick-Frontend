    ...
    <div className='w-[580px]' style={{padding: '17px 21px'}}>
        ...
        <div className='flex justify-between items-center'>
            <div className='flex items-center gap-2'>
                ...
                <h1 className='text-[20px] font-bold tracking-[0.03em] text-black opacity-95'>All</h1>
            </div>
            <div className='flex items-center gap-2'>
        ...
        <form style={{marginBlock: '18px 13px'}} className='relative'>
