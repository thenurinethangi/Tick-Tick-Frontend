    ...
    <div className='w-[580px]' style={{padding: '17px 21px'}}>
        ...
        <div className='flex justify-between items-center'>
            <div className='flex items-center gap-2'>
                ...
                <h1 className='text-[20px] font-bold tracking-[0.03em] text-black opacity-95'>Completed</h1>
            </div>
        </div>
        ...
        <div style={{marginBottom: '15px'}}>
            ...
            <div className='flex flex-col gap-2 bg-[#F5F5F5] rounded-sm' style={{paddingTop: '8px'}}>
                <div className='flex justify-between items-center' style={{paddingInline: '15px 5px'}}>
                    <div className='flex items-center gap-2'>
                        <input type='checkbox' defaultChecked className='w-3.5 h-3.5 accent-[#E0E0E0]'></input>
                        <p className='text-[14.7px] text-[#BDBDBD]'>Develop TickTick Frondend</p>
                    </div>
                    <div className='flex items-center gap-2'>
