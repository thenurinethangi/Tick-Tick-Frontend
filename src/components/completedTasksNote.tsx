...
import {CalendarRange, Flag, Minus, Timer, ListStart} from "lucide-react";

function CompletedTasksNote() {
  return (
    <div className='w-[400px] bg-white border-l border-gray-200'>
        <div className='border-b border-gray-100 flex justify-between items-center' style={{padding: '15px 20px'}}>
            <div className='flex items-center gap-2.5'>
                <input type='checkbox' checked className='w-4 h-4 accent-[#E0E0E0]'></input>
...
export default CompletedTasksNote